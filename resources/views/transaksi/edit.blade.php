...
<div class="container">
    <div class="card shadow">
        <div class="card-header bg-success text-white">
            <h4 class="mb-0">Edit Transaksi Sampah</h4>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="harga_per_kg" id="harga_per_kg" 
                                   ...
                                   value="{{ old('harga_per_kg', $transaksi->harga_per_kg) }}" min="1" required>
                            @error('harga_per_kg')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="berat_kg" id="berat_kg" 
                                   ...
                                   value="{{ old('berat_kg', $transaksi->berat_kg) }}" min="0.1" required>
                            @error('berat_kg')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
